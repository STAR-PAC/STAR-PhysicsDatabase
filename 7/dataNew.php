...
?>
   ...
   <!----- no global tags (e.g. BODY, HTML) needed ----->
    ...
    <h2><span class="normaltext"><font color="#ff8c00" face="Arial,Helvetica,Geneva,Swiss,SunSans-Regular">Antideuteroin and Antihelium production in Au+Au Collisions at sqrt(s<sub>nn</sub>) = 130 GeV</font><font face="Arial,Helvetica,Geneva,Swiss,SunSans-Regular"><br>
          C. Adler <i>et al., </i>Phys. Rev. Lett. 87, 262301 (2001)<br>
        </font></span></h2>
    <hr noshade>
